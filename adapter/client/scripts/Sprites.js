...
function mainEntrance(data) {
   ...
   var bodyDef = new b2BodyDef,blackholeDef,blackholefixDef,blackhole,
   attholeDef,attholefixDef,atthole,gate1Def,gate1fixDef,gate1,gate2Def,gate2fixDef,gate2,
   gate1Exists = false,gate2Exists = false,
...
/*
   ...
   */
   ...
   function updatePhy() {
      ...
      if(keyMsg2)
      {
        ...
        keyStatus_list.splice(0,1);    //从0开始，删除1个       
      }
  ...
  if(keyStatus&1){  //jump
    //jump();
    //iscarMoving = true;
      myself.ApplyImpulse(new b2Vec2(0,-400), myself.GetWorldCenter());  
  }
  if(keyStatus&2 ){   //left
